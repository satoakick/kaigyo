...
If you want to develop `Kaigyo::SqlParser` (lib/kaigyo/sql_parser.rb), please execute the following command after changing `lib/kaigyo/sql.y`
```
(in path/to/kaigyo)
racc -o lib/kaigyo/sql_parser.rb lib/kaigyo/sql.y -E
```
